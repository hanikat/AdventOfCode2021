...
using AdventOfCode2021.Problems.Problem26;

namespace AdventOfCode2021.Answers.Problems26
{
    public class Problem26 : Problem
    {
        ...
        public override string ProblemName
        {
            get
            {
                return "Day 13: Transparent Origami - Part Two";
            }
        }
        ...
        protected override string GetSolution()
        {
            ...
            {
                paper.PerformFoldInstruction(instruction);
            }
            
            
            return paper.PrintDots();
        }
